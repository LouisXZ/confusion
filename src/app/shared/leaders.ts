...
export const LEADERS: Leader[] = [
    {
        ...
        description: 'Our CEO, Peter, credits his hardworking East Asian immigrant parents \
            who undertook the arduous journey to the shores of America with the intention of giving their children \
            the best future. His mother\'s wizardy in the kitchen whipping up the tastiest dishes \
            with whatever is available inexpensively at the supermarket, \
            was his first inspiration to create the fusion cuisines for which The Frying Pan became well known. \
    ...
    },
    {
        ...
        abbr: 'CFO',
        featured: false,
        description: 'Our CFO, Danny, as he is affectionately referred to by his colleagues, \
            comes from a long established family tradition in farming and produce. \
    ...
    },
    {
        ...
        abbr: 'CTO',
        featured: false,
        description: 'Blessed with the most discerning gustatory sense, Agumbe, our CFO, \
            personally ensures that every dish that we serve meets his exacting tastes. \
            Our chefs dread the tongue lashing that ensues if their dish does not meet his exacting standards. \
            He lives by his motto, You click only if you survive my lick.'
    },
    {
        id: 3,
        ...
        description: 'Award winning three-star Michelin chef with wide International experience having worked closely with\
            ...
            He says, Put together the cuisines from the two craziest cultures, and you get a winning hit! Amma Mia!'
    }
];
